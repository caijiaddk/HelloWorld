...
public interface Friend_ServiceAsync {
	...
	void deleteFriend(int userid, int friendid , AsyncCallback<String> asyncCallback);
	
	void saveFriend(int userid,String friendname,AsyncCallback<Friends_Client> asyncCallback);
