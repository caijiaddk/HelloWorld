...
public interface Calendar_Service extends RemoteService {
	...
	/**save a Calendar*/
	Integer saveCalendar(Calendar_Client calendarClient,Client_Workflow client_Workflow);
	
	/**update a calendar*/
	Integer updateCalendar (Calendar_Client calendarClient,Client_Workflow client_Workflow);
