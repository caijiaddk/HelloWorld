							...
							table.addTableListener(new TableListenerAdapter() {
								...
								public void onClick(SourcesTableEvents sender,
									...
									if (widget instanceof Button) {
										...
										for (int i = 0; i < panel_Overview.googleCalendarPanel.dayView
												.getAppointmentCount(); i++) {
											AppointmentMod temp = (AppointmentMod) panel_Overview.googleCalendarPanel.dayView
													.getAppointmentAtIndex(i);
											if (temp.calendarClient
													.getCalendarid().equals(
															row.getValue(5))) {
												panel_Overview.googleCalendarPanel.workflowApp = temp;
