...
public class Panel_Overview extends DockPanel {
	...
	public Panel_GoogleCalendar googleCalendarPanel;
	...
	public Panel_Overview(final User_Main user_main) {
		...
		googleCalendarPanel = new Panel_GoogleCalendar(this);
	...
	public void settings_show() {
		...
		googleCalendarPanel.setVisible(false);
	...
	public VerticalPanel createNorthPanel() {
		...
		headPanel.setHorizontalAlignment(HasAlignment.ALIGN_RIGHT);
	...
	public AbsolutePanel createWestPanel() {
		...
		// add link
		{
			...
			createHyperlink.addClickHandler(new ClickHandler(){
				...
				public void onClick(ClickEvent event) {
					...
					Date date = new Date();
					appt.setStart(new Date(date.getYear(), date.getMonth(), date.getDate(),
							date.getHours(), date.getMinutes()));
					long Time = (date.getTime() / 1000) + 60 * 60;
					Date date2 = new Date();
					date2.setTime(Time * 1000);
					appt.setEnd(new Date(date2.getYear(), date2.getMonth(), date2
							.getDate(), date2.getHours(), date2.getMinutes()));
					...
					googleCalendarPanel.workflowApp=appt;
					workflow_show();
		...
		{
			west_Panel.add(googleCalendarPanel.leftPanel, 0, westheight);
	...
	public VerticalPanel createCenterPanel() {
		...
		workflowpanel = new Panel_Workflow(overviewPanel, googleCalendarPanel);
		...
		googleCalendarPanel.setWidth("100%");
		calendar_show();
