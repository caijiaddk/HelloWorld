	...
	public void Init() {
		...
		// part 1
		{
			...
			for (int i = 0; i < contentItem_service_rank.getValueList().size(); i++) {
				...
				service_rank_item_table
						.setWidget(1, i+1, radioButton);
				radioButton
		...
		// part 2
		{
			...
			nostandardsrequirementitems_panel.removeStyleName("gwt-DisclosurePanel");
			...
			for (int i = 0; i < NoStandards_contentBlock.getContentItemsList()
				...
				FlexCellFormatter flexCellFormatter = ns_flexTable.getFlexCellFormatter();
				...
				DOM.setStyleAttribute(flexCellFormatter.getElement(0, 0), "background", "#EEEEEE");
		...
		// part 3
		{
			...
			for (int i = 0; i < standard_contentBlock.getContentItemsList()
				...
				FlexCellFormatter flexCellFormatter = standard_flexTable.getFlexCellFormatter();
