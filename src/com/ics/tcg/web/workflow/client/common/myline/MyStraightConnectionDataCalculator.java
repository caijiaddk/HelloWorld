package com.ics.tcg.web.workflow.client.common.myline;
...
public class MyStraightConnectionDataCalculator implements
	...
	public ConnectionData calculateConnectionData(List connectors) {
		...
		Point center1 = new Point(c1.getLeft() + c1.getWidth(), c1.getTop() + c1.getHeight()/2);
		Point center2 = new Point(c2.getLeft(), c2.getTop() + c2.getHeight()/2);
